...
200     sgn0 = 1
    ...
    SUBROUTINE AddProjectorWeakGeneric()
      ...
      INTEGER :: ElemCands, TotCands, ElemHits, TotHits, EdgeHits, CornerHits, &
          ...
          Nrange1, Centeri, CenteriM, AllocStat, ElemCode, LinCode, ElemCodeM, LinCodeM
      ...
      CALL Info('LevelProjector','Initialialization done',Level=12)
...
100       IF( Repeating ) THEN
      ...
      CALL Info('LevelProjector','Looping done',Level=12)
